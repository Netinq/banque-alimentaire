...
mapboxgl.accessToken =
    "pk.eyJ1IjoibmV0aW5xIiwiYSI6ImNra2N0azJvajBpOWoycHFydWRkcWo5MXMifQ.iCXY_CWx5r8KEOHHCGu3iw";
...
geojson.features.forEach(function (marker) {
    ...
    el.addEventListener("click", function () {
        Array.from(document.getElementsByClassName("marker")).forEach((elem) => {
        ...
        document.getElementById("container").animate([
            ...
            { transform: "translateY(0)", opacity: 1 },], { duration: 300, }
        );
